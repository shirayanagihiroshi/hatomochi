(function () {
  ...
  var sudoku = create_suudoku(),
    ...
    + '</tr>'
    + '<tr>'
      + '<td>(1)</td><td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(2)</td><td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(3)</td><td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(4)</td><td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(5)</td><td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(6)</td><td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(7)</td><td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(8)</td><td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
    + '</tr>'
    + '<tr>'
      + '<td>(9)</td><td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
      + '<td class="edi blue"></td><td class="edi blue"></td><td class="edi blue"></td>'
      + '<td class="edi pink"></td><td class="edi pink"></td><td class="edi pink"></td>'
    + '</tr>';

//  $(window).on('load', table_test_start()); これでも動く気がしたけど、うまくいかない
//  window.onload = function () {
//  数独だけ動かしてたときは動いたけど、他のサンプルと一緒にしたら動かなくなった
//  window.onload　はいくつか記述があると、そのうちひとつしか動かないらしい
  window.addEventListener("load",function() {

    console.log('naze!!');

    $('.sudoku').html(sudoku_table_str);

    // 上のように動的にHTMLを追加する場合、
    // 追加してからイベントハンドラを登録しないとうまく動かない
    ...
    // 解く
    $('.sudoku_solv').on('click', function (event) {
      calc_and_set();
